...
try:
    ...
    font24 = ImageFont.truetype('/usr/share/fonts/truetype/freefonts/FreeMonoBold.ttf', 24)
    drawblack.text((10, 0), 'hello world', font = font24, fill = 0)
    drawblack.text((10, 20), '5.83inch e-Paper B', font = font24, fill = 0)
    ...
    LBlackimage = Image.new('1', (epd5in83b.EPD_HEIGHT, epd5in83b.EPD_WIDTH), 255)  # 126*298
    LRedimage = Image.new('1', (epd5in83b.EPD_HEIGHT, epd5in83b.EPD_WIDTH), 255)  # 126*298
    # Vertical
    drawblack = ImageDraw.Draw(LBlackimage)
    drawred = ImageDraw.Draw(LRedimage)
    font18 = ImageFont.truetype('/usr/share/fonts/truetype/freefonts/FreeMonoBold.ttf', 18)
    drawblack.text((2, 0), 'hello world', font = font18, fill = 0)
    drawblack.text((2, 20), '5.83inch e-Paper B', font = font18, fill = 0)
    ...
    print("read bmp file")
    HBlackimage = Image.open('5in83b-b.bmp')
    HRedimage = Image.open('5in83b-r.bmp')
    epd.display(epd.getbuffer(HBlackimage), epd.getbuffer(HRedimage))
    time.sleep(2)
    ...
    newimage = Image.open('example.bmp')
